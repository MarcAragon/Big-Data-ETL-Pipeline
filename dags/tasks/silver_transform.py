...
# # límites pequeños para prueba estable
# USERS_LIMIT = 2000
# COMMENTS_LIMIT = 2000
# POSTS_LIMIT = 500
...
# def overwrite_iceberg_table(df: DataFrame, table_name: str) -> None:
#     (
...
#     print(f"Escribiendo tabla {USERS_TABLE} en Nessie...")
#     overwrite_iceberg_table(df_users, USERS_TABLE)

#     print(f"Tabla creada/actualizada: {USERS_TABLE}")
...
#     print(f"Escribiendo tabla {COMMENTS_TABLE} en Nessie...")
#     overwrite_iceberg_table(df_comments, COMMENTS_TABLE)

#     print(f"Tabla creada/actualizada: {COMMENTS_TABLE}")
...
#     print(f"Escribiendo tabla {POSTS_TABLE} en Nessie...")
#     overwrite_iceberg_table(df_posts, POSTS_TABLE)

#     print(f"Tabla creada/actualizada: {POSTS_TABLE}")
